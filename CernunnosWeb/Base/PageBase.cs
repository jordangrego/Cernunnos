...
{
    /// <summary>
    /// Contem os métodos padrões de todas as telas do sistema.
    /// </summary>
    public class PageBase : System.Web.UI.Page
    {
        ...
        public CustomIdentity UsuarioLogado
        {
            get
            {
                return this.User.Identity as CustomIdentity;
            }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            {
                ExceptionHelper.LogException(ex, this.Request.Path);
                this.Page.ClientScript.RegisterStartupScript(this.Page.GetType(), "ERROR", "AlertaErro('<strong>Ocorreu um erro no sistema!</strong> Favor entrar em contato com a área responsável.');", true);
            }
        }
            ...
            foreach (Control ctrl in parent.Controls)
            {
                ...
                else if (ctrl is LinkButton)
                {
                    if (!((LinkButton)ctrl).Text.Contains("Download") &&
                        ...
                        !((LinkButton)ctrl).CssClass.Contains("enabled") &&
        ...
        /// </summary>
        protected void EscondeControlesMaster()
        {
            var master = Master as Site;
            if (master != null)
            {
                // master.EscondeControlesMaster();
            }
        }
